define [
  'base_controller'
  'apps/loots/delete/delete_view'
  'lib/concerns/controllers/table_selections'
  'lib/components/flash/flash_controller'
], ->
  @Pro.module "LootsApp.Delete", (Delete, App, Backbone, Marionette, $, _) ->
    class Delete.Controller extends App.Controllers.Application
      ...
      onFormSubmit: ->
        ...
        jQuery.ajax
          url: Routes.destroy_multiple_workspace_loots_path(workspace_id: WORKSPACE_ID)
          type: 'DELETE'
          data:
            selections:
