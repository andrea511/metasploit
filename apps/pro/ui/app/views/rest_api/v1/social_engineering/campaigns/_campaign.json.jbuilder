...
json.web_pages campaign.web_pages, partial: '/rest_api/v1/social_engineering/web_pages/web_page', as: :web_page
json.emails campaign.emails, partial: '/rest_api/v1/social_engineering/emails/email', as: :email
