...
function completely(container, config) {
    ...
    var createDropDownController = function(elem) {
        ...
        var onMouseDown =  function() {
            var noselect = this.querySelector('[noselect]')
            if (noselect) {
                return noselect.click();
            }
            p.hide();
        ...
        var p = {
            ...
            refresh : function(token, array) {
                ...
                for (var i=0;i<array.length;i++) {
                    ...
                    divRow.innerHTML = token+'<div>'+array[i].substring(token.length)+'</div>';
                    rows.push(divRow);
            ...
            move : function(step) { // moves the selection either up or down (unless it's not possible) step is either +1 or -1.
                ...
                if (rows[ix+step].querySelector('[noselect]'))      return rows[ix].__hint;
                ix+=step; 
                p.highlight(ix);
    ...
    var rs = { 
        ...
        repaint : function() {
            ...
            var w = calculateWidthForText(leftSide);
            dropDown.style.left = w+'px';
