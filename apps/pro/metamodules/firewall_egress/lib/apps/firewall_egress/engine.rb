class Apps::FirewallEgress::Engine < ::Rails::Engine
  ...
  initializer 'firewall_egress.prepend_factory_path',
    ...
    if defined? FactoryBot
      ...
      # unshift so that projects that use firewall_egress can modify firewall_egress_* factories
