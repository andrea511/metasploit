...
# Standard library
#
#  TODO: this class is shamelessly copied from framework 4.x to suppress a module
#  that crashes ruby silently without exceptions when running inside a windows service
#
#
    ...
    ApplicationRecord.connection_pool.with_connection do
      ...
      [
        ...
        mt[1].keys.sort.each do |mn|
          ...
          next if mn == 'gather/http_pdf_authors'
          obj = mt[1].create(mn)
          next if not obj
          begin
