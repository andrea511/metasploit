...
REM Get the calling file name
for %%x in (%0) do set BATCHCMD=%%~nx

REM Call the appropriate script
CALL C:\metasploit\ruby\bin\ruby.exe C:\metasploit\apps\pro\vendor\bundle\ruby\3.0.0\bin\%BATCHCMD% %*
