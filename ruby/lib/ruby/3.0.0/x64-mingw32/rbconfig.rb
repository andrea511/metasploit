...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--prefix=/' '--enable-shared' '--disable-install-doc' '--disable-jit-support' '--host=x86_64-w64-mingw32' '--without-ext=tk/tkutil,tk,syslog,pty,readline' 'host_alias=x86_64-w64-mingw32' 'CFLAGS=-O3 -DFD_SETSIZE=2048 -fno-omit-frame-pointer -fno-fast-math -Wall -Wextra -Wno-unused-parameter -Wno-parentheses -Wno-long-long -Wno-missing-field-initializers -Wunused-variable -Wpointer-arith -Wwrite-strings -Wdeclaration-after-statement -Wimplicit-function-declaration'"
  ...
  CONFIG["DLDSHARED"] = "$(CC) -m64 -shared -static-libgcc"
  CONFIG["DLDLIBS"] = ""
  ...
  CONFIG["DLEXT2"] = ""
  CONFIG["DLEXT"] = "so"
  CONFIG["LDSHAREDXX"] = "$(CXX) -m64 -shared -static-libgcc -static-libstdc++"
  CONFIG["LDSHARED"] = "$(CC) -m64 -shared -static-libgcc"
  CONFIG["CCDLFLAGS"] = ""
  CONFIG["STATIC"] = ""
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "x86_64-w64-mingw32-gcc.exe (Rev2, Built by MSYS2 project) 10.3.0\nCopyright (C) 2020 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  CONFIG["CC_VERSION"] = "$(CC) --version"
  CONFIG["MJIT_CC"] = "C:/tools/msys64/mingw64/bin/x86_64-w64-mingw32-gcc.exe"
  CONFIG["CSRCFLAG"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
  ...
  CONFIG["LDFLAGS"] = "-L. "
  CONFIG["CFLAGS"] = "-O3 -DFD_SETSIZE=2048 -fno-omit-frame-pointer -fno-fast-math -Wall -Wextra -Wno-unused-parameter -Wno-parentheses -Wno-long-long -Wno-missing-field-initializers -Wunused-variable -Wpointer-arith -Wwrite-strings -Wdeclaration-after-statement -Wimplicit-function-declaration"
