  ...
  class Index
    ...
    def search_by_dependency(dependency, base = nil)
      ...
      @cache[base || false][dependency] ||= begin
        ...
        # Rapid7 HACK:
        # If a ruby version is available, prefer it over a mingw version
        # so we force compilation of extensions.
        spec_platforms = found.map { |s| s.platform.to_s }
          if spec_platforms.include?('ruby') && spec_platforms.any? {|s| s.match /mswin|mingw/}
            found.reject! { |spec| spec.platform.to_s.match(/mswin|mingw/) }
          end
